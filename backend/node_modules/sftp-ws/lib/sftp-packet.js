...
var SftpPacketReader = (function (_super) {
    ...
    function SftpPacketReader(buffer, raw) {
        _super.call(this);
        this.buffer = buffer;
        this.position = 0;
    ...
    SftpPacketReader.prototype.readInt16 = function () {
    ...
    SftpPacketReader.prototype.readUint16 = function () {
        this.check(2);
    ...
    SftpPacketReader.prototype.readStructuredData = function () {
